...
async function starts() {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["628987351166@s.whatsapp.net"] // replace this with your number
...
case 'term':
	               ...
	               exec(cmd, (err, stdout) => {
		           if(err) return client.sendMessage(from, "Error Mank", text, { quoted: mek })
		           if (stdout) {
